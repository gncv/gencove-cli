...
class ApiEndpoints(Enum):
    ...
    PROJECT_CANCEL_SAMPLES = "/api/v2/project-cancel-samples/{id}"
    ...
    PROJECT_COPY_SAMPLES = "/api/v2/project-samples-copy/"
...
MINIMUM_SUPPORTED_PYTHON_MAJOR, MINIMUM_SUPPORTED_PYTHON_MINOR = 3, 9

RESTORE_TIERS_SUPPORTED = ["Standard", "Expedited", "Bulk"]
